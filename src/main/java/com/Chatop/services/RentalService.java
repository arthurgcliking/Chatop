...
public class RentalService {
    ...
    // Returns a rental with the specified ID
    ...
    public RentalDTO updateRental(Long rentalId, RentalDTO rentalDetails) {
        RentalDAO rental = rentalRepository.findById(rentalId).orElse(null);
        if (rental == null) {
          return new RentalDTO(); // or return null, depending on your preference
        }
